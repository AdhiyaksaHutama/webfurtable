        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Pilih jenis pendaftaran</h5>
                    {{-- <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button> --}}
                </div>
                <form action="{{ route('pilihpendaftaran') }}" method="get">
                    @csrf
                    <div class="modal-body">
                        {{-- <a href="{{ route('ppdb') }}" class="">Daftar Siswa
                        Baru</a>
                    <a href="{{ route('siswapindahan') }}" class="siswapindahan">Daftar
                        Siswa Pindahan</a> --}}
                        <input type="radio" name="pendaftaran" value="siswapindahan">
                        <label for="Siswa">Siswa Pindahan</label><br>
                        <input type="radio" name="pendaftaran" value="siswabaru">
                        <label for="Siswa">Siswa Baru</label>
                    </div>
                        ...
                        <div class="service-item wow bounceInUp" data-wow-duration="1s" data-wow-delay="0.3s">
                            <div class="row">
                                <div class="col-lg-4">
                                    {{-- <div class="icon"></div> --}}
                                    @php
                                        $gmabar = \App\Models\Gambar_Kegiatan::where('kegiatan_id', $p->id)->first();
                                    @endphp
                                    <img src="{{ asset('kegiatan/' . $gmabar->gambar) }}" alt="dsd">
                                </div>
                                <div class="col-lg-8">
                                    <div class="right-content">
